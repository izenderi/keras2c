...
void iNAS_0222_initialize(float** CONV_0_output_array 
...
*CONV_0_bias_array = k2c_read_array("iNAS_0222CONV_0_bias_array.csv",8); 
...
*CONV_1_bias_array = k2c_read_array("iNAS_0222CONV_1_bias_array.csv",8); 
...
*CONV_2_bias_array = k2c_read_array("iNAS_0222CONV_2_bias_array.csv",4); 
...
*CONV_3_bias_array = k2c_read_array("iNAS_0222CONV_3_bias_array.csv",16); 
...
*CONV_4_bias_array = k2c_read_array("iNAS_0222CONV_4_bias_array.csv",4); 
...
*FC_END_bias_array = k2c_read_array("iNAS_0222FC_END_bias_array.csv",10); 
} 

void iNAS_0222_terminate(float* CONV_0_output_array,float* CONV_0_kernel_array,float* CONV_0_bias_array,float* CONV_1_output_array,float* CONV_1_kernel_array,float* CONV_1_bias_array,float* CONV_2_output_array,float* CONV_2_kernel_array,float* CONV_2_bias_array,float* CONV_3_output_array,float* CONV_3_kernel_array,float* CONV_3_bias_array,float* CONV_4_output_array,float* CONV_4_kernel_array,float* CONV_4_bias_array,float* GAVGPOOL_0_output_array,float* FC_END_kernel_array,float* FC_END_bias_array) { 
