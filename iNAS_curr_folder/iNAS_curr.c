...
void iNAS_curr_initialize(float** CONV_0_output_array 
...
*CONV_0_output_array = k2c_read_array("iNAS_currCONV_0_output_array.csv",8192); 
*CONV_0_kernel_array = k2c_read_array("iNAS_currCONV_0_kernel_array.csv",24); 
*CONV_0_bias_array = k2c_read_array("iNAS_currCONV_0_bias_array.csv",8); 
*CONV_1_output_array = k2c_read_array("iNAS_currCONV_1_output_array.csv",7200); 
*CONV_1_kernel_array = k2c_read_array("iNAS_currCONV_1_kernel_array.csv",576); 
*CONV_1_bias_array = k2c_read_array("iNAS_currCONV_1_bias_array.csv",8); 
*CONV_2_output_array = k2c_read_array("iNAS_currCONV_2_output_array.csv",2704); 
*CONV_2_kernel_array = k2c_read_array("iNAS_currCONV_2_kernel_array.csv",800); 
*CONV_2_bias_array = k2c_read_array("iNAS_currCONV_2_bias_array.csv",4); 
*CONV_3_output_array = k2c_read_array("iNAS_currCONV_3_output_array.csv",9216); 
*CONV_3_kernel_array = k2c_read_array("iNAS_currCONV_3_kernel_array.csv",576); 
*CONV_3_bias_array = k2c_read_array("iNAS_currCONV_3_bias_array.csv",16); 
*CONV_4_output_array = k2c_read_array("iNAS_currCONV_4_output_array.csv",1296); 
*CONV_4_kernel_array = k2c_read_array("iNAS_currCONV_4_kernel_array.csv",3136); 
*CONV_4_bias_array = k2c_read_array("iNAS_currCONV_4_bias_array.csv",4); 
*GAVGPOOL_0_output_array = k2c_read_array("iNAS_currGAVGPOOL_0_output_array.csv",4); 
*FC_END_kernel_array = k2c_read_array("iNAS_currFC_END_kernel_array.csv",40); 
*FC_END_bias_array = k2c_read_array("iNAS_currFC_END_bias_array.csv",10); 
} 

void iNAS_curr_terminate(float* CONV_0_output_array,float* CONV_0_kernel_array,float* CONV_0_bias_array,float* CONV_1_output_array,float* CONV_1_kernel_array,float* CONV_1_bias_array,float* CONV_2_output_array,float* CONV_2_kernel_array,float* CONV_2_bias_array,float* CONV_3_output_array,float* CONV_3_kernel_array,float* CONV_3_bias_array,float* CONV_4_output_array,float* CONV_4_kernel_array,float* CONV_4_bias_array,float* GAVGPOOL_0_output_array,float* FC_END_kernel_array,float* FC_END_bias_array) { 
